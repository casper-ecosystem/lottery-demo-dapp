...
function isDeploy(object: DeployMessage) {
	return (
		...
		(object.detected_deploy.error === null ||
			typeof object.detected_deploy.error === 'string') &&
...
export const WebSocketProvider: React.FC<WebSocketProviderProps> = ({
	...
	return (
		<WebSocketContext.Provider value={{ deploy }}>
			{children}
...
export const useWebSocketDeployData = (): WebSocketContextType => {
	...
	if (context === undefined) {
		throw new Error(
			'useWebSocketData must be used within a WebSocketProvider'
		);
	}
	return context;
};
